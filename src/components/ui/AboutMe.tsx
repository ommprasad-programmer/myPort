                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-white/70 leading-relaxed text-lg">
                            <p>
                                My passion for technology began with a simple curiosity about how digital experiences are crafted.
                                Today, I am a Full Stack Developer and UI/UX Designer dedicated to building high-fidelity web applications
                                that solve real-world problems.
                            </p>
                            <p>
                                From mastering complex architectures in Java and React to designing intuitive user interfaces,
                                I thrive in environments that challenge my technical and creative limits.
                            </p>
                            <p className="border-l-4 border-neon-cyan pl-6 italic">
                                Currently, I am deep-diving into the world of **AI Integration**, exploring how Large Language Models
                                can be seamlessly woven into web applications to create smarter, more autonomous user experiences.
                            </p>
                        </div>
                    </motion.div>
                        ...
                        <div className="glass-card p-10 rounded-[3rem] relative overflow-hidden group">
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <p className="text-white/60 mb-8">
                                    Integrating Generative AI, RAG architectures, and autonomous agents into modern web stacks.
                                </p>

                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl">
                                        <Sparkles className="text-neon-cyan" size={20} />
                                        <span className="text-sm font-medium">Coming Soon: AI-Integrated Experiments</span>
                                    </div>
                                    <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl opacity-50">
                                        <Rocket className="text-neon-violet" size={20} />
                                        <span className="text-sm font-medium">Deep Learning Workshops</span>
                                    </div>
                                </div>
